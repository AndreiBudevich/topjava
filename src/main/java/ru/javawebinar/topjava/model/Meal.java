...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String CALORIES_ERROR = "Calories must be between 10 and 5000";
    ...
    @Range(min = 10, max = 5000, message = CALORIES_ERROR)
    @NotNull(message = CALORIES_ERROR)
